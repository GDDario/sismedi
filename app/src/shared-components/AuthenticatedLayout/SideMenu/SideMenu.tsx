        ...
        <div className="relative h-screen min-w-[240px] w-[11vw]">
            <div
                ...
                <div className="banana flex-grow flex flex-col justify-end pb-4">
                    <button
                        className="group w-[80%] h-6 px-2 py-4 border-black border flex justify-start items-center shadow-md rounded-tr-md rounded-br-md bg-mainWhite gap-2 transition-all hover:w-[90%]">
